/*
  ...
  2G1516 Formal Methods - Alternating Bit Protocol
...
#define LOSS 0  /* Set loss to 0 if the model should simulate lost messages. */
...
#define msg0 (to_rcvr?[msg(0)])
#define msg1 (to_rcvr?[msg(1)])
